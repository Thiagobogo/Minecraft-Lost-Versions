...
public class Particle extends Entity {
    ...
    public Particle(Level level, float x, float y, float z, float xa, float ya, float za, int tex) {
        ...
        this.setPos(x, y, z);
        this.xd = xa + (float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F;
        this.yd = ya + (float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F;
        this.zd = za + (float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F;
        ...
        this.size = (float)(Math.random() * (double)0.5F + (double)0.5F);
        this.lifetime = (int)((double)4.0F / (Math.random() * 0.9 + 0.1));
        this.age = 0;
    }
